...
btnInsertUpdate.addEventListener("click", () => {
    ...
    if(btnInsertUpdate.value == "insert") {
        ...
        document.getElementById("btnSaveToLocal").style.display = "inline";
...
function sortRecords() {
    ...
    const sortLetter = document.getElementById("sortLetter").value;

    if (sortName && sortLetter) {
        if (sortName === "fname") {
            if (sortLetter === "az") {
                arrRecords.sort((a, b) => a.fname.localeCompare(b.fname));
            } else if (sortLetter === "za") {
...
btnClearItems.addEventListener("click", () => {
    ...
    document.getElementById("sortLetter").style.display = "none";
    document.getElementById("sortby").style.display = "none";
    document.getElementById("btnSaveToLocal").style.display = "none";
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (savedData) {
        ...
        arrRecords = JSON.parse(savedData).records;
